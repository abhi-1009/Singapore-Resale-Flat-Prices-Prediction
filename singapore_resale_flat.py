...
def predict_price(year,town,flat_type,flr_area_sqm,flat_model,stry_start,stry_end,re_les_year,
    ...
    with open(r"C:/Users/Hp/OneDrive/Desktop/python/Resale_Flat_Prices_Model_1.pkl","rb") as f:
...
with st.sidebar:
    select= option_menu("MAIN MENU",["Home", "About the project", "Price Prediction"])

if select == "Home":
    col1,col2= st.columns(2)
    
    with col1:
        st.image(Image.open(r"C:\Users\Hp\OneDrive\Desktop\python\images_singapore.jfif"))
    
    with col2:
        st.image(Image.open(r"C:\Users\Hp\OneDrive\Desktop\python\singapore_images.jfif"))
